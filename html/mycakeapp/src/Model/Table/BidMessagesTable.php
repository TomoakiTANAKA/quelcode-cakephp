 ...
 * BidMessages Model
 *
 * @property \App\Model\Table\BidInformationsTable&\Cake\ORM\Association\BelongsTo $BidInformations
...
class BidMessagesTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('bid_messages');
        $this->setDisplayField('id');
        $this->setPrimaryKey('id');

        $this->addBehavior('Timestamp');

        $this->belongsTo('BidInformations', [
    ...
    {
        $rules->add($rules->existsIn(['bid_information_id'], 'BidInformations'));
